...
<body style="background: #f3f3f3;">
    ...
    <div class="mj-container" style="background-color:#f3f3f3;">
        <!--[if mso | IE]>
        ...
        <div style="margin:0px auto;max-width:600px;background:#ffffff;">
            <table role="presentation" cellpadding="0" cellspacing="0"
                ...
                <tbody>
                    <tr>
                        <td style="text-align:center;vertical-align:top;border:1px solid #eee;direction:ltr;font-size:0px;padding:20px 0px;">
                            <!--[if mso | IE]>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:15px 30px 5px;">
                                                ...
                                                <![endif]-->
                                                <div style="cursor:auto;color:#333333;font-family:'Open Sans', Arial;font-size:20px;font-weight:700;line-height:22px;text-align:left;">
                                                    {{ $subject }}
                                                </div>
                                                <!--[if mso | IE]>
                                                </td></tr></table>
                                            ...
                                            <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:15px 30px;">
                                                ...
                                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="vertical-align:undefined;width:600px;">
                                                <![endif]-->
                                                <div style="cursor:auto;color:#444;font-family:'Open Sans', Arial;font-size:14px;line-height:22px;text-align:left;">
                                                    {!! $description !!}
                                                </div>
                                                <!--[if mso | IE]>
                                                </td></tr></table>
                                        ...
                                        <tr>
                                            <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:15px 30px;">
                                                ...
                                                <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;width:100%;" align="center" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td style="border:none;border-radius:3px;color:#fff;cursor:auto;padding:15px;" align="center" valign="middle" bgcolor="#4a90e2"><a href="{{ $action_button['href'] }}" style="text-decoration:none;background:#4a90e2;color:#fff;font-family:'Open Sans', Arial;font-size:18px;font-weight:normal;line-height:120%;text-transform:none;margin:0px;" target="_blank">{{ $action_button['text'] }}</a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <!--[if mso | IE]>
                                        ...
                                        <tr>
                                            <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:15px 30px 5px;">
                                                ...
                                                <div class="mj-column-per-100 outlook-group-fix"
                                                    ...
                                                    <table role="presentation" cellpadding="0" cellspacing="0"
                                                           style="border:1px solid #ddd;border-top:4px solid #4a90e2;"
                                                           width="100%" border="0">
                                                        <tbody>
                                                            <tr>
                                                                <td style="word-wrap:break-word;font-size:0px;padding:5px;"
                                                                    align="left">
