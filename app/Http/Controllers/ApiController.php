...
class ApiController extends Controller
{
     ...
     * @return mixed
     */
    public function respondBadRequest($exception, $message = 'Ops, não foi possível identificar sua ação, tente novamente.')
    {
     ...
     * @return mixed
     */
    public function respondNotFound($exception, $message = 'Ops, não foi possível encontrar o que você está procurando.')
    {
     ...
     * @return mixed
     */
    public function respondInternalError($exception, $message = 'Ops, parece que o sistema não conseguiu executar a ação, entre em contato com o administrador.')
    {
     ...
     * @return mixed
     */
    public function respondUnauthorized($exception, $message = 'Ops, você não está autorizado a executar essa ação')
    {
